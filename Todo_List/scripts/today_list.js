...
dailyScores.possibleScore = Math.round(Math.random()* 14 + 1);
dailyScores.currentScore = Math.round(dailyScores.possibleScore * 60/100);
document.querySelector('.js-daily-score').innerHTML = `Possible score for Today: ${dailyScores.possibleScore} pts`;
document.querySelector('.js-current-score').innerHTML = `Your current score is: ${dailyScores.currentScore} pts`;
